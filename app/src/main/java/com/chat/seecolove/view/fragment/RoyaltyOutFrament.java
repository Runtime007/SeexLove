...
/**
 */
public class RoyaltyOutFrament extends BaseFragment implements View.OnClickListener {
    private View view;
    ...
    public static RoyaltyOutFrament newInstance(int position) {

        Log.e("cccccccccccc", "newInstance");
        final RoyaltyOutFrament f = new RoyaltyOutFrament();
...
//        recyclerView.setItemAnimator(new DefaultItemAnimator());
    ...
    public void initData() {
        LogTool.setLog("getBillHistory initData :", position);
        getBillHistory();
