...
public class XikeWelcomeActivity extends Activity implements EasyPermission.PermissionCallback {
    ...
    private void initViews() {
        ...
        viewPageVie.setOnButtonOnClickListener(new SeexWelComeViewPageView.OnButtonOnClickListener() {
            ...
            public void onClickListener() {
                SharedPreferencesUtils.put(XikeWelcomeActivity.this, "welcome_load", true);
                checkSession();
            }
        });
    }
...
//            checkSession();
    ...
    private void checkSession() {
        ...
        Intent  intent = new Intent(XikeWelcomeActivity.this, MainActivity.class);
