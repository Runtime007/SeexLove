...
import com.chat.seecolove.wxapi.WXEntryActivity;
import com.chat.seecolove.wxpay.bean.OrederSendInfo;
import com.chat.seecolove.wxpay.common.Constants;
...
//            Toast.makeText(App.getContext(),"APP_ID为空",Toast.LENGTH_LONG).show();
        }
        //拼接密钥
        sb.append("key=");
