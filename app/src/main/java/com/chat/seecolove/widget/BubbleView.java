...
public class BubbleView extends RelativeLayout{
    ...
    public BubbleView setDefaultDrawableList(){
        ...
        drawableList.add(ContextCompat.getDrawable(mContext, R.mipmap.gift_0));
        drawableList.add(ContextCompat.getDrawable(mContext, R.mipmap.gift_1));
        drawableList.add(ContextCompat.getDrawable(mContext, R.mipmap.gift_2));
        drawableList.add(ContextCompat.getDrawable(mContext, R.mipmap.gift_3));
        drawableList.add(ContextCompat.getDrawable(mContext, R.mipmap.gift_4));
        drawableList.add(ContextCompat.getDrawable(mContext, R.mipmap.gift_5));
        drawableList.add(ContextCompat.getDrawable(mContext, R.mipmap.gift_6));
        drawableList.add(ContextCompat.getDrawable(mContext, R.mipmap.gift_7));
        drawableList.add(ContextCompat.getDrawable(mContext, R.mipmap.gift_8));
