package com.chat.seecolove.widget.wheel;
...
//    private static final int VALUE_TEXT_COLOR = 0xFFFFFFFF;
    private static final int VALUE_TEXT_COLOR = 0xFFEBCF00;
...
//    private static final int ITEMS_TEXT_COLOR = 0xFF000000;
    private static final int ITEMS_TEXT_COLOR = 0xFFd4d4d4;
    ...
    private void initResourcesIfNecessary() {
        if (itemsPaint == null) {
            ...
            itemsPaint.setTextSize(Tools.dip2px(TEXT_SIZE));
        }
        ...
        if (valuePaint == null) {
            ...
            valuePaint.setTextSize(Tools.dip2px(TEXT_SIZE));
