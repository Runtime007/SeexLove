...
public class RoundFileProgressBar extends View {
    ...
    public RoundFileProgressBar(Context context) {
        this(context, null);
    }

    public RoundFileProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        defStyle(context,attrs);
    }

    public RoundFileProgressBar(Context context, AttributeSet attrs, int defStyle) {
