...
import com.chat.seecolove.anima.DepthPageTransformer;
import com.chat.seecolove.anima.ViewPagerScroller;
...
public class ImageCycleView extends LinearLayout {
    ...
    private void init(Context context){
        ...
        FrameLayout.LayoutParams params = new FrameLayout.LayoutParams
                (FrameLayout.LayoutParams.MATCH_PARENT, MyApplication.screenWidth/2);
        params.gravity = Gravity.BOTTOM;

    }
    public void setImageResources(List<Banner> infos,ImageCycleViewListener imageCycleViewListener) {
    ...
    private class ImageCycleAdapter extends PagerAdapter {
        ...
        public ImageCycleAdapter(Context context,  List<Banner> infos,ImageCycleViewListener imageCycleViewListener) {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            if (mImageViewCacheList.isEmpty()) {
                imageView = (SimpleDraweeView) LayoutInflater.from(mContext).inflate(R.layout.banner_item, null);
