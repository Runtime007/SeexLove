...
public class CommonVideoView extends FrameLayout implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, View.OnTouchListener, View.OnClickListener, Animator.AnimatorListener, SeekBar.OnSeekBarChangeListener {
    ...
    private ImageView return_video_play;
    ...
    private void initView() {
        ...
        return_video_play = (ImageView) view.findViewById(R.id.return_video_play);
        ...
        return_video_play.setOnClickListener(this);
    ...
    public void onPrepared(MediaPlayer mp) {
        ...
        videoPauseImg.setImageResource(R.mipmap.play_icon_video_stop);
    ...
    public void onCompletion(MediaPlayer mp) {
        ...
        videoPlayImg.setImageResource(R.mipmap.play_icon_video_play);
    }
        ...
        switch (v.getId()) {
            ...
            case R.id.videoPlayImg:
                if (videoView.isPlaying()) {
                    ...
                    videoView.start();
                    videoPlayImg.setImageResource(R.mipmap.play_icon_video_stop);
                }
                break;
            ...
            case R.id.viewBox:
                ...
                //                            curY, curY + videoControllerLayout.getHeight()+ DensityUtil.dip2px(getContext(),20));
