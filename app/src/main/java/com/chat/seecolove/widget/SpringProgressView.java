...
public class SpringProgressView extends View {
    ...
    private static final int[] SECTION_COLORS = {Color.rgb(249, 217, 98),Color.rgb(233, 150, 126),Color.rgb(229, 126, 102),Color.rgb(179, 58, 30)};
    /**进度条最大值*/
    ...
    protected void onDraw(Canvas canvas) {
        ...
        RectF rectProgressBg = new RectF(0, 0, (mWidth-0)*section, mHeight-0);
